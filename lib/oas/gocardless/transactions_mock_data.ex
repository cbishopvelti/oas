     ...
     [
       %{
         ...
         "remittanceInformationUnstructured" =>
           "0543 06JAN25      LV INSURANCE W    0330 1239970 GB",
         "transactionAmount" => %{"amount" => "45", "currency" => "GBP"},
         "transactionId" =>
           "8AD4A5144E8D4C5987C0BAC4913DBD6340C9D083424B1AA5F38729B4A81C3C3E82153E637BD4BAA5CD31D80B26B28495"
       }
     ],
     [
    ...
    {:ok,
     [
       %{
         ...
         "remittanceInformationUnstructured" =>
           "Albany            CHRIS BISHOP      VIA ONLINE - PYMT FP 10/02/25 10    03102227707126000N",
         "transactionAmount" => %{"amount" => "-10.00", "currency" => "GBP"},
         "transactionId" =>
           "8AD4A5144E8D4C5987C0BAC4913DBD637C1183938B7FDEEC31BD3280DF58208B6F66AD4CDA4DBFDAEC4CD17574883600"
       },
       %{
         ...
         "proprietaryBankTransactionCode" => "POS",
         "remittanceInformationUnstructured" =>
           "0543 06FEB25      BENDYSTUDIO       PETHERTON ROA GB",
         "transactionAmount" => %{"amount" => "-6.06", "currency" => "GBP"},
         "transactionId" =>
           "8AD4A5144E8D4C5987C0BAC4913DBD63C64DD72D01B64EC0CDCD3879F56D2B0DFF3D22B59685E453B66353FBBA6D0E38"
       },
       %{
         "bookingDate" => "2025-02-07",
         "bookingDateTime" => "2025-02-07T00:00:00.000Z",
         ...
         "proprietaryBankTransactionCode" => "BAC",
         "remittanceInformationUnstructured" =>
           "CAROL BISHOP      MORTGAGELOAN      FP 07/02/25 1232  00155663632BHWCSBB",
         "transactionAmount" => %{"amount" => "9500.00", "currency" => "GBP"},
         "transactionId" =>
           "8AD4A5144E8D4C5987C0BAC4913DBD63C64DD72D01B64EC0CDCD3879F56D2B0DA83C63321000FFFC5D59FCD6A5CA3D11"
       },
       %{
         ...
         "proprietaryBankTransactionCode" => "BAC",
         "remittanceInformationUnstructured" =>
           "CAROL BISHOP      MORTGAGELOAN      FP 06/02/25 1245  00155663632BHWCCLC",
         "transactionAmount" => %{"amount" => "10000.00", "currency" => "GBP"},
         "transactionId" =>
           "8AD4A5144E8D4C5987C0BAC4913DBD635F559F563AED0C5F56331D61D0541E76FBAB5EA3760DE90525CF86CD078B0F4E"
       },
       %{
         ...
         "transactionId" =>
           "8AD4A5144E8D4C5987C0BAC4913DBD63341720D80F633C6D3F34971EF9BD0AA733D95BA898E2398248B4784166F5598E"
       },
       %{
         "bookingDate" => "2025-02-05",
         "bookingDateTime" => "2025-02-05T00:00:00.000Z",
         ...
         "transactionId" =>
           "8AD4A5144E8D4C5987C0BAC4913DBD63341720D80F633C6D3F34971EF9BD0AA7A5430486BED4BA8FA26A416C484A00BF"
       }
     ]}
  end
end
