defmodule OasWeb.Schema do
  ...
  def myMiddleware(
        middleware,
        %Absinthe.Type.Field{identifier: :public_register},
        %Absinthe.Type.Object{identifier: :mutation}
      ) do
    middleware
  end
  ...
  def myMiddleware(
        middleware,
        %Absinthe.Type.Field{identifier: :public_tokens},
        %Absinthe.Type.Object{identifier: :query}
      ) do
    middleware
  end
  ...
  def myMiddleware(
        middleware,
        %Absinthe.Type.Field{identifier: :public_member},
        %Absinthe.Type.Object{identifier: :query}
      ) do
    middleware
  end
  ...
  def myMiddleware(
        middleware,
        %Absinthe.Type.Field{identifier: :public_bacs},
        %Absinthe.Type.Object{identifier: :query}
      ) do
    middleware
  end
  ...
  def myMiddleware(
        middleware,
        %Absinthe.Type.Field{identifier: :public_outstanding_attendance},
        %Absinthe.Type.Object{identifier: :query}
      ) do
    middleware
  end
  ...
  def myMiddleware(
        middleware,
        %Absinthe.Type.Field{identifier: :public_config_tokens},
        %Absinthe.Type.Object{identifier: :query}
      ) do
    middleware
  end
  ...
  def myMiddleware(
        middleware,
        %Absinthe.Type.Field{identifier: :public_config_config},
        %Absinthe.Type.Object{identifier: :query}
      ) do
    middleware
  end
  ...
  def myMiddleware(
        middleware,
        %Absinthe.Type.Field{identifier: :public_credits},
        %Absinthe.Type.Object{identifier: :query}
      ) do
    middleware
  end
  ...
  def myMiddleware(
        middleware,
        %Absinthe.Type.Field{identifier: :public_config_llm},
        %Absinthe.Type.Object{identifier: :query}
      ) do
    middleware
  end
  ...
  # User resolvers
  def myMiddleware(middleware, %Absinthe.Type.Field{identifier: :user}, %Absinthe.Type.Object{
        identifier: :query
      }) do
  ...
  def myMiddleware(
        middleware,
        %Absinthe.Type.Field{identifier: :user_bookings},
        %Absinthe.Type.Object{identifier: :query}
      ) do
    [OasWeb.Schema.MiddlewareUser | middleware]
  end
  ...
  def myMiddleware(
        middleware,
        %Absinthe.Type.Field{identifier: :user_add_attendance},
        %Absinthe.Type.Object{identifier: :mutation}
      ) do
    [OasWeb.Schema.MiddlewareUser | middleware]
  end
  ...
  def myMiddleware(
        middleware,
        %Absinthe.Type.Field{identifier: :user_undo_attendance},
        %Absinthe.Type.Object{identifier: :mutation}
      ) do
    [OasWeb.Schema.MiddlewareUser | middleware]
  end
  ...
  def myMiddleware(
        middleware,
        %Absinthe.Type.Field{identifier: :user_attendance_attendance},
        %Absinthe.Type.Object{identifier: :subscription}
      ) do
    [OasWeb.Schema.MiddlewareUser | middleware]
  end

  # isAdmin and isReviewer can read data
  def myMiddleware(middleware, _field, %Absinthe.Type.Object{identifier: identifier})
