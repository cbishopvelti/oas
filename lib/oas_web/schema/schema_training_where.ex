  ...
  object :training_where_queries do
    field :training_where, :training_where do
      ...
      resolve(fn _, %{id: id}, _ ->
        ...
        result =
          from(tw in Oas.Trainings.TrainingWhere,
      ...
      resolve(fn _, %{training_where_id: training_where_id, when: when1}, _ ->
        result =
          from(twt in Oas.Trainings.TrainingWhereTime,
            where:
              twt.training_where_id == ^training_where_id and
                twt.day_of_week == ^Date.day_of_week(Date.from_iso8601!(when1))
          )
          |> Oas.Repo.one()
        ...
        case Oas.Repo.get(Oas.Trainings.TrainingWhere, id) do
          ...
          training_where ->
            try do
              ...
              |> Ecto.Changeset.no_assoc_constraint(:trainings)
              |> Oas.Repo.delete()
