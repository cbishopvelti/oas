...
export const Home = () => {
  return <div>
    ...
    <p>You can come to 3 sessions as a temporary member before you must become a full member, full membership to the 31st of October is 6 GBP. Please register <a href="">here</a></p>
  </div>
}