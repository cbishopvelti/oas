...
import { get, includes, set, filter as lodashFilter, differenceWith, differenceBy } from 'lodash'
...
export const TrainingTags = ({
  ...
  `)
  const training_tags = get(data, 'training_tags', [])
  useEffect(() => {
    refetch()
  }, [formData.saveCount])
  ...
  return <Autocomplete
    ...
    filterOptions={(options, params, b, c) => {
      ...
      console.log("001", options, params)
