defmodule Oas.CreditsTest do
  ...
  describe "credits" do
    ...
    test "One credit" do
      ...
      result = Oas.Credits.Credit.process_credits([t1])
      |> elem(0)
      |> List.last()
    ...
    test "Two credits" do
      ...
      result = Oas.Credits.Credit.process_credits(data)
      |> elem(0)
      |> List.last()
      |> Map.get(:after_amount)
    ...
    test "deduct_debit handles expired credits" do
      ...
      total = Enum.reduce(result, Decimal.new("0"), fn %{amount: amount}, acc ->
